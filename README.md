...
- **Personal**: [LongMemEval](https://github.com/THU-KEG/LongMemEval)
- **Medical**: [MIRIAD](https://github.com/Ariel-Zheng/MIRIAD)
- **Financial**: [FinQA](https://github.com/czyssrs/FinQA)

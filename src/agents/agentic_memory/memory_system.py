    ...
    def analyze_content(self, content: str) -> Dict:            
        ...
        prompt = """Generate a structured analysis of the following content by:
            ...
            Format the response as a JSON object:
            {
                ...
                "context": 
                    // A single factual statement capturing the core information, Ignore useless information.
                    // Act as a knowledge extractor: state the facts, rules, or preferences explicitly.
                    // Ensure accurate extraction.
                    // Do not use conversational filler or meta-commentary like "The speaker states" or "The text is about".
                ,
                "tags": [
